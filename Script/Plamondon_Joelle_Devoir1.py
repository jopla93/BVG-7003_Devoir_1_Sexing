...
#file_path = "C:/Users/joell/Documents/Bioinfo/2_Data_RNASeq_Cannabis_Sex/2_Data_RNASeq_Cannabis_Sex.csv"

# Pour entrer le chemin du fichier CSV selon l'utilisateur
file_path = input("entrez le path du fichier : ")
...
def figure(data_REM16, data_FT1, data_filtered):
    ...
    g1=sns.boxplot(data=data_REM16, x='Gene_Sexe', y='Expression', hue='Sexe', # cree le box plot. Si on a changé les noms des gènes, il faut changer le nom du dataframe
                   width=0.3,  # Réduit la largeur du boxplot
                   showcaps=False,  # Supprime les caps aux extrémités des moustaches
                   whiskerprops={'linewidth': 1})  # Ajuste l'épaisseur des moustaches
    ...
    g1.get_legend().remove() #enleve la legende
    ...
    # Graphique pour FT1
    fig2=plt.figure()
    g2=sns.boxplot(data=data_FT1, x='Gene_Sexe', y='Expression', hue='Sexe', width = 0.3, showcaps = False, whiskerprops = {'linewidth': 1}) #attention au nom du dataframe
    ...
    fig3=plt.figure()
    g3=sns.boxplot(data=data_filtered, x='Gene_Sexe', y='Expression', hue='Gene', width = 0.3, showcaps = False, whiskerprops = {'linewidth': 1}) #attention au nom du dataframe
